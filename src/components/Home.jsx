       ...
       <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
          <div className='flex flex-col justify-center h-full'>
            <h2 className='text-4xl sm:text-7xl font bold text-white'> I'm a FrontEnd Developer
             ...
             py-4 max-w-md' > 
              I am a passinate Developer who love to learn new technology.
              Currently, I love to work on web application using technologies like React,Tailwind,Javascript.
             </p>
             <div>
